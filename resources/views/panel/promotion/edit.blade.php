                        ...
                        <div class="col-md-8">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="1 = todos ganan; y 2, gana 1 de cada 2 participantes" min="1" max="10" value="{{ old('attempts', $promotion->attempts) }}" name="attempts">
                                </div>
                                <div class="form-group">
