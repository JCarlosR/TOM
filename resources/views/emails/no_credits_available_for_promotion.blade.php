...
<head>
    ...
    <title>No pueden participar en tu promo</title>
</head>
<body>
    <h3>Hola {{ $user->name }},</h3>

    <p>Hay una persona que esta interesada en tus promociones y no pudo tener acceso a tu tombofan por que no haz renovado tu suscripción, y podrías estar perdiendo oportunidades de venta de tu producto o servicio. </p>

    <p>Para renovar tu suscripción es muy fácil solo debes dar clic en alguna de las siguentes opciones y seguir las instrucciones:</p>
